//
//  BSBusinessDetailViewController.m
...
@implementation BSBusinessDetailViewController
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        case 0:
        {
            heightForRow = BSBusinessDetailTableViewTitleCellHeiht;
        ...
        case 2:
        {
            heightForRow = BSBusinessDetailTableViewContentCellHeiht;
        }
            break;
        case 3:
        {
            heightForRow = BSBusinessDetailTableViewDescriptionCellHeight;
        }
            break;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        case 0:
        {
            BSBusinessDetailTableViewTitleCell * cell = [BSBusinessDetailTableViewTitleCell cellForTableView:tableView];
        ...
        case 2:
        {
            BSBusinessDetailTableViewContentCell * cell = [BSBusinessDetailTableViewContentCell cellForTableView:tableView];
            [cell configureCellForRowAtIndexPath:indexPath model:self.model tableView:tableView];
            cellX = cell;
        }
            break;
        case 3:
        {
            BSBusinessDetailTableViewDescriptionCell * cell = [BSBusinessDetailTableViewDescriptionCell cellForTableView:tableView];
            [cell configureCellForRowAtIndexPath:indexPath model:self.model tableView:tableView];
            cellX = cell;
        }
            break;
