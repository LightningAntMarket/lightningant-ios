...
//同意退币
static NSString * GetGoodsBack = @"GoodsBack/index/oid/%@";

@interface BSOrderTableViewFooterCell ()<BSOrderSalesReturnViewControllerDelegate>
...
@implementation BSOrderTableViewFooterCell
...
+ (instancetype)cellForTableView:(UITableView *)tableView{
    static NSString *cellID1 = @"BSOrderTableViewFooterCellID";
    BSOrderTableViewFooterCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID1];
    if (cell == nil) {
        cell = [[BSOrderTableViewFooterCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:cellID1];
