...
/**
 *  钱包模块数据缓存
 *  参阅 https://www.jianshu.com/p/9f516878796a
 **/
...
//keystore
@property (nonatomic, readwrite ,copy) NSString * keystore;
...
@property (nonatomic,readonly) NSArray<BSWalletData *> * walletDatas;
