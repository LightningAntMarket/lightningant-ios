...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if ([self.walletData isEqual:[BSWalletCache shareInstance].walletData]) {
    ...
    switch (indexPath.section) {
        ...
        case 1:
        {
            switch (indexPath.row) {
                case 0:
                {
                    BSTradePayoutViewController * vc = [[BSTradePayoutViewController alloc]initWithWalletData:self.walletData];
